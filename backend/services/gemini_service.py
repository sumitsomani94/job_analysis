"""Gemini API calls — lazy client initialization."""
...
async def _chat_json(system_instruction: str, prompt: str) -> dict[str, Any]:
    _ensure_configured()
    try:
...
async def match_skills_strict(
    ...
    if cv_text and cv_text.strip():
        # Gemini handles larger contexts but we'll cap to be safe
